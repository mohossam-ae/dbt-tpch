...
final as (
    select
        -- SCD-2 mechanism placeholders (enrichment for DE Agent integration tests).
        -- In a real SCD-2 implementation these would be generated by a
        -- snapshot strategy; kept here as stable passthrough expressions.
        cast(c.customer_key as bigint) as customer_sk,
